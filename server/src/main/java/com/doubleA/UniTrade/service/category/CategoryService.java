...
public class CategoryService implements ICategoryService {
  ...
  public Category addCategory(Category category) {
    return Optional.of(category)
        ...
        .orElseThrow(
            () -> new EntityExistsException(category.getName() + " category already exists"));
  }

  // This method update category information.
  // It first checks if the category with the given ID exists in the database.
  // If it does, it updates the name of the category with the new name provided in the category
  // object.
