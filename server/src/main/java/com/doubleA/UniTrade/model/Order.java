...
public class Order {
  ...
  // instead of enum position number. So when order changes in
  // server/src/main/java/com/doubleA/UniTrade/enums/OrderStatus.java,
  ...
  // Add a column named user_id to Order entity as foreign key to establish Many Order to One User
  // relationship.
  @ManyToOne
