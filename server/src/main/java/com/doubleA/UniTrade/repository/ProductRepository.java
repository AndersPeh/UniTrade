...
public interface ProductRepository extends JpaRepository<Product, Long> {
  ...
  // When user types anything, it will be converted to lowercase name. Then it will be compared to
  // lowercase name of
  // products. As long as the user enters name that matches any part of the product name, results
  // will be returned.
  ...
  @Query(
      "SELECT DISTINCT p FROM Product p JOIN p.images i JOIN i.visualTags vtag"
