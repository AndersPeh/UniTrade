...
// Cart Component
// This component will display the user's shopping cart
// It will allow the user to increase or decrease the quantity of items in the cart
// It will also allow the user to remove items from the cart
// User's cart information is fetched from the Redux store and updated using Redux actions
const Cart = () => {
