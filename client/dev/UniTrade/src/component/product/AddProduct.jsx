...
// This component allows users to add a new product with details like name, description, price, brand, category, and inventory
// It includes a stepper to guide users through adding product details
