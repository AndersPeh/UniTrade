...
// This component renders a form for adding or editing an address
// It includes fields for street, city, state, country, phone number, and address type
// The form can be customized to show or hide certain fields and buttons based on props
const AddressForm = ({
  address,
  onChange,
  onSubmit,
