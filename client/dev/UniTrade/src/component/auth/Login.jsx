...
// It accepts email and password inputs
// and dispatches the login action to authenticate the user
// On successful login, the user is redirected to the previous page or home page
const Login = () => {
  ...
  // redirect to previous page or home on successful login
  useEffect(() => {
    if (isAuthenticated) {
